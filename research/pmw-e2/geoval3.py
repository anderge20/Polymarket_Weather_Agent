        ...
        for lead in LEADS:
            ...
            if not cand:
                rows.append(dict(event_id=e['event_id'],icao=e['icao'],city=e['city'],tz=e['tz'],
                    target_date=e['target_date'],region=e['region'],model=m,lead=lead,run=None,age_h=None,f=None,y=y)); continue
            ...
            rows.append(dict(event_id=e['event_id'],icao=e['icao'],city=e['city'],tz=e['tz'],
                target_date=e['target_date'],region=e['region'],model=m,lead=lead,run=rt.strftime("%Y-%m-%dT%H:%MZ"),
...
json.dump(rows,open("MODELSEL_GEOVAL_V3_RAW.json","w"),indent=1)
